...
class TestObstacle(unittest.TestCase):
    ...
    def test_is_equal_to(self):
        ...
        obstacle = Obstacle(obstacle_sprite, Point(1, 1), 150)
        # Create a Obstacle equal to obstacle
        obstacle_copy = Obstacle(obstacle_sprite, Point(1, 1), 150)
        # Create a Obstacle in a different logical place
        obstacle_diff_logical_position = Obstacle(obstacle_sprite,
                                                  Point(2, 2), 150)
